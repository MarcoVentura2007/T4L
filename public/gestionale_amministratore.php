...
<head>
    ...
    <title>T4L | Gestionale Amministratore</title>
...
<body>
                ...
                <div class="page-tab" id="tab-agenda">
                    ...
                    <div class="modal-box large" id="modalCreaAgenda">
                        ...
                        <form id="formCreaAgenda">
                            ...
                            <div class="edit-field">
                                <label>Note</label>
                                <textarea id="agendaNote" placeholder="Note sull'attività..." rows="3"></textarea>
                            </div>
                            <div class="modal-actions">
                                <button type="button" class="btn-secondary" onclick="closeModal()">Chiudi</button>
                                <button type="submit" class="btn-primary">Salva</button>
                    ...
                    <div class="modal-box large" id="modalModificaAgenda">
                        ...
                        <form id="formModificaAgenda">
                            ...
                            <div class="edit-field">
                                <label>Note</label>
                                <textarea id="modAgendaNote" placeholder="Note sull'attività..." rows="3"></textarea>
                            </div>
                            <div class="modal-actions">
                                <button type="button" class="btn-secondary" onclick="closeModal()">Annulla</button>
                                <button type="submit" class="btn-primary">Salva</button>
                ...
                <div class="page-tab" id="tab-educatori">
                    ...
                    <div class="modal-box large" id="modalAggiungiEducatore">
                        ...
                        <form id="formAggiungiEducatore">
                            <div class="edit-field"><label>Nome</label><input type="text" id="educatoreNome" placeholder="Nome" required></div>
                            ...
                            <div class="edit-field"><label>Codice Fiscale</label><input type="text" id="educatoreCF" placeholder="Codice Fiscale" required></div>
                            <div class="edit-field"><label>Telefono</label><input type="text" id="educatoreTelefono" placeholder="Telefono"></div>
                            <div class="edit-field"><label>Email</label><input type="email" id="educatoreMail" placeholder="Email"></div>
                            <div class="modal-actions">
                                <button type="button" class="btn-secondary" onclick="closeModal()">Chiudi</button>
                                <button type="submit" class="btn-primary">Salva</button>
                            </div>
                    ...
                    <div class="modal-box large" id="modalModificaEducatore">
                        ...
                        <form id="formModificaEducatore">
                            ...
                            <div class="edit-field"><label>Nome</label><input type="text" id="editEducatoreNome" placeholder="Nome" required></div>
                            ...
                            <div class="edit-field"><label>Codice Fiscale</label><input type="text" id="editEducatoreCF" placeholder="Codice Fiscale" required></div>
                            <div class="edit-field"><label>Telefono</label><input type="text" id="editEducatoreTelefono" placeholder="Telefono"></div>
                            <div class="edit-field"><label>Email</label><input type="email" id="editEducatoreMail" placeholder="Email"></div>
                            <div class="modal-actions">
                                <button type="button" class="btn-secondary" onclick="closeModal()">Chiudi</button>
                ...
                <div class="page-tab" id="tab-account">
                    ...
                    <div class="modal-box large" id="modalAggiungiAccount">
                        ...
                        <form id="formAggiungiAccount">
                            <div class="edit-field"><label>Nome Utente</label><input type="text" id="accountNomeUtente" placeholder="Nome utente" required></div>
                            <div class="edit-field"><label>Password</label><input type="password" id="accountPassword" placeholder="Password" autocomplete="off" required></div>
                            <div class="edit-field">
                                <label>Classe</label>
                            ...
                            <div class="edit-field"><label>Codice Univoco</label><input type="text" id="accountCodice" placeholder="Codice univoco" required></div>
                            <div class="modal-actions">
                                <button type="button" class="btn-secondary" onclick="closeModal()">Chiudi</button>
                                <button type="submit" class="btn-primary">Salva</button>
    ...
    <nav class="mobile-bottom-nav">
        ...
        <a href="#" class="mobile-nav-item" data-tab="tab-educatori" onclick="switchTab('tab-educatori',this);return false;">
            <div class="mobile-nav-icon"><img src="immagini/educatore.png" alt="educatori"></div>
        ...
        <a href="#" class="mobile-nav-item" data-tab="tab-account" onclick="switchTab('tab-account',this);return false;">
            <div class="mobile-nav-icon"><img src="immagini/account.png" alt="account"></div>
    ...
    <!-- Birthday picker — educatore aggiungi -->
    <div class="birth-cal-overlay" id="birthCalOverlayEduAdd">
        <div class="birth-cal-picker" id="birthCalPickerEduAdd">
            <div class="birth-cal-header">
                <div class="birth-cal-month-row">
                    <button class="cal-nav-btn" id="birthCalPrevMonthEduAdd" type="button"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M15 18l-6-6 6-6" />
                        </svg></button>
                    <span class="birth-cal-month-label" id="birthCalMonthLabelEduAdd"></span>
                    <button class="cal-nav-btn" id="birthCalNextMonthEduAdd" type="button"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M9 18l6-6-6-6" />
                        </svg></button>
                </div>
                <div class="birth-cal-year-row">
                    <button class="birth-year-nav" id="birthCalPrevDecadeEduAdd" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M18 17l-5-5 5-5M11 17l-5-5 5-5" />
                        </svg></button>
                    <button class="birth-year-nav" id="birthCalPrevYearEduAdd" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M15 18l-6-6 6-6" />
                        </svg></button>
                    <select class="birth-year-select" id="birthCalYearSelectEduAdd"></select>
                    <button class="birth-year-nav" id="birthCalNextYearEduAdd" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M9 18l6-6-6-6" />
                        </svg></button>
                    <button class="birth-year-nav" id="birthCalNextDecadeEduAdd" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
            ...
            <div class="cal-grid" id="birthCalGridEduAdd"></div>
        </div>
    </div>
    <!-- Birthday picker — educatore modifica -->
    <div class="birth-cal-overlay" id="birthCalOverlayEduEdit">
        <div class="birth-cal-picker" id="birthCalPickerEduEdit">
            <div class="birth-cal-header">
                <div class="birth-cal-month-row">
                    <button class="cal-nav-btn" id="birthCalPrevMonthEduEdit" type="button"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M15 18l-6-6 6-6" />
                        </svg></button>
                    <span class="birth-cal-month-label" id="birthCalMonthLabelEduEdit"></span>
                    <button class="cal-nav-btn" id="birthCalNextMonthEduEdit" type="button"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M9 18l6-6-6-6" />
                        </svg></button>
                </div>
                <div class="birth-cal-year-row">
                    <button class="birth-year-nav" id="birthCalPrevDecadeEduEdit" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M18 17l-5-5 5-5M11 17l-5-5 5-5" />
                        </svg></button>
                    <button class="birth-year-nav" id="birthCalPrevYearEduEdit" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M15 18l-6-6 6-6" />
                        </svg></button>
                    <select class="birth-year-select" id="birthCalYearSelectEduEdit"></select>
                    <button class="birth-year-nav" id="birthCalNextYearEduEdit" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M9 18l6-6-6-6" />
                        </svg></button>
                    <button class="birth-year-nav" id="birthCalNextDecadeEduEdit" type="button"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
                            <path d="M6 17l5-5-5-5M13 17l5-5-5-5" />
                        </svg></button>
                </div>
            </div>
            ...
            <div class="cal-grid" id="birthCalGridEduEdit"></div>
        </div>
    </div>
    ...
    <button type="button" class="allegato-remove" data-index="${index}" title="Rimuovi">×</button>`;
        ...
        formAggiungiUtente.onsubmit = async function(e) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    alert("Errore: " + data.message);
                    setButtonLoading(submitBtn, false); // riabilita solo in caso di errore
                }
            } catch (err) {
        ...
        document.getElementById("saveEdit").onclick = async function() {
            ...
            if (editType === 'presenza') {
                ...
                try {
                    const r = await fetch('api/api_modifica_presenza.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Requested-With': 'XMLHttpRequest'
                ...
                try {
                    ...
                    if (fotoInput && fotoInput.files.length > 0) {
                        ...
                        const r = await fetch('api/api_aggiorna_utente.php', {
                            method: 'POST',
                            body: fd
                        });
                        data = await r.json();
        ...
        aggiungiAccountBtn.onclick = () => openModal(modalAggiungiAccount);
        if (aggiungiAccountBtnMobile) aggiungiAccountBtnMobile.onclick = () => openModal(modalAggiungiAccount);
        ...
        document.querySelectorAll(".edit-account-btn").forEach(btn => {
            btn.onclick = e => {
                const row = btn.closest("tr");
                document.getElementById("editAccountNomeUtente").value = row.dataset.nome_utente;
                document.getElementById("editAccountNomeUtenteDisplay").value = row.dataset.nome_utente;
                document.getElementById("editAccountClasse").value = row.dataset.classe;
                document.getElementById("editAccountCodice").value = row.dataset.codice;
        ...
        document.querySelectorAll(".delete-account-btn").forEach(btn => {
            btn.onclick = e => {
                ...
                document.querySelector("#modalDeleteAccount h3").innerText = "Elimina account: " + rowToDeleteAccount.dataset.nome_utente;
        ...
        document.getElementById("confirmDeleteAccount").onclick = () => {
            ...
            fetch("api/api_elimina_account.php", {
                    ...
                    body: JSON.stringify({
                        nome_utente: rowToDeleteAccount.dataset.nome_utente
                    })
                })
                .then(r => r.json()).then(data => {
                    if (data.success) {
        ...
        if (aggiungiEducatoreBtn) aggiungiEducatoreBtn.onclick = () => {
            document.getElementById('educatoreData').value = '';
            document.getElementById('educatoreDataDisplay').value = '';
            var _b = document.getElementById('birthCalBtnEduAdd');
            if (_b && _b._setBirthDate) _b._setBirthDate(null);
            openModal(modalAggiungiEducatore);
        };
        if (aggiungiEducatoreBtnMobile) aggiungiEducatoreBtnMobile.onclick = () => openModal(modalAggiungiEducatore);
            ...
            formAggiungiEducatore.onsubmit = function(e) {
                ...
                fetch("api/api_aggiungi_educatore.php", {
                        ...
                        body: JSON.stringify({
                            nome,
                            cognome,
                            data_nascita: document.getElementById("educatoreData").value,
                            codice_fiscale: document.getElementById("educatoreCF").value.trim(),
                            telefono: document.getElementById("educatoreTelefono").value.trim(),
                            mail: document.getElementById("educatoreMail").value.trim()
                        })
                    })
                    .then(r => r.json()).then(data => {
                        if (data.success) {
        ...
        document.querySelectorAll(".edit-educatore-btn").forEach(btn => {
            btn.onclick = e => {
                const row = btn.closest("tr");
                document.getElementById("editEducatoreId").value = row.dataset.id;
                document.getElementById("editEducatoreNome").value = row.children[0].innerText;
                document.getElementById("editEducatoreCognome").value = row.children[1].innerText;
                (function() {
                    var iso = row.dataset.nascita || '';
                    document.getElementById('editEducatoreData').value = iso;
                    var parts = iso.split('-');
                    document.getElementById('editEducatoreDataDisplay').value = iso ? parts[2] + '/' + parts[1] + '/' + parts[0] : '';
                    var _b = document.getElementById('birthCalBtnEduEdit');
                    if (_b && _b._setBirthDate) {
                        _b._setBirthDate(iso ? new Date(+parts[0], +parts[1] - 1, +parts[2]) : null);
                    }
                })();
                document.getElementById("editEducatoreCF").value = row.children[3]?.innerText || "";
                document.getElementById("editEducatoreTelefono").value = row.children[4]?.innerText || "";
                document.getElementById("editEducatoreMail").value = row.children[5]?.innerText || "";
                openModal(modalModificaEducatore);
            };
        });

        document.getElementById("salvaModificaEducatore")?.addEventListener("click", e => {
            e.preventDefault();
            ...
            fetch("api/api_modifica_educatore.php", {
                    ...
                    body: JSON.stringify({
                        ...
                        nome,
                        cognome,
                        data_nascita: document.getElementById("editEducatoreData").value,
                        codice_fiscale: document.getElementById("editEducatoreCF").value.trim(),
                        telefono: document.getElementById("editEducatoreTelefono").value.trim(),
                        mail: document.getElementById("editEducatoreMail").value.trim()
                    })
                })
                .then(r => r.json()).then(data => {
                    if (data.success) {
        ...
        document.querySelectorAll(".delete-educatore-btn").forEach(btn => {
            btn.onclick = e => {
                ...
                document.querySelector("#modalDeleteEducatore h3").innerText = "Elimina educatore: " + rowToDeleteEducatore.children[0].innerText;
        ...
        document.getElementById("confirmDeleteEducatore")?.addEventListener("click", () => {
            ...
            fetch("api/api_elimina_educatore.php", {
                    ...
                    body: JSON.stringify({
                        id: rowToDeleteEducatore.dataset.id
                    })
                })
                .then(r => r.json()).then(data => {
                    if (data.success) {
        ...
        function displayAgenda(dayIndex) {
            ...
            dayActs.forEach(att => {
                ...
                // Crea una mappa dei educatori per cercare il nome dell'istruttore
                const educatoriMap = {};
                att.educatori.forEach(e => {
                    educatoriMap[e.id] = `${e.nome} ${e.cognome}`;
                });

                const ragFotos = Array.from(new Map(att.ragazzi.map(r => [r.id, r])).values()).map(r => {
                    const tipoLabel = r.gruppo == 1 ? '(Gruppo)' : '(Individuale)';
                    return `<div class="ragazzo-item"><img src="${r.fotografia}" class="ragazzo-avatar"><span class="ragazzo-cognome">${r.cognome}</span><span style="display:block;font-size:0.85em;color:#666;">${tipoLabel}</span></div>`;
                }).join('') || '—';
        ...
        document.querySelectorAll('.ragazzo-checkbox').forEach(cb => {
            cb.addEventListener('change', function() {
                ...
                const selGruppo = label.querySelector('.ragazzo-gruppo');
                const selIstruttore = label.querySelector('.ragazzo-istruttore');

                if (this.checked) {
                    if (selGruppo) selGruppo.style.display = 'inline-block';
                    // Il select istruttore appare solo se è già Individuale
                    if (selGruppo && parseInt(selGruppo.value) === 0) {
                        updateIstruttoriSelects();
                        if (selIstruttore) selIstruttore.style.display = 'inline-block';
                    }
                } else {
                    if (selGruppo) selGruppo.style.display = 'none';
                    if (selIstruttore) {
                        selIstruttore.style.display = 'none';
                        selIstruttore.value = '';
                    }
                }
            });
        ...
        function updateModIstruttoriSelects() {
            const educatori = Array.from(document.querySelectorAll(".mod-educatore-checkbox:checked"))
                .map(cb => ({
                    id: parseInt(cb.value, 10),
                    label: cb.closest('label').querySelector('span').textContent.trim()
                }))
                .filter(e => !isNaN(e.id) && e.id > 0);

            document.querySelectorAll('.mod-ragazzo-istruttore').forEach(select => {
                const lbl = select.closest('label');
                const cb = lbl.querySelector('.mod-ragazzo-checkbox');
                const selGruppo = lbl.querySelector('.mod-ragazzo-gruppo');
                const isChecked = cb && cb.checked;
                const isIndividuale = selGruppo && parseInt(selGruppo.value) === 0;
                ...
                educatori.forEach(edu => {
                    ...
                    opt.value = edu.id;
                    opt.textContent = edu.label;
                    select.appendChild(opt);
                });
                if (educatori.find(e => String(e.id) === String(currentValue))) {
                    select.value = currentValue;
                }

                select.style.display = (isChecked && isIndividuale && educatori.length > 0) ? 'inline-block' : 'none';
            });
        }
        ...
        document.addEventListener('click', function(e) {
            ...
            document.getElementById('modAgendaNote').value = att.note || '';
            ...
            document.querySelectorAll('.mod-ragazzo-checkbox').forEach(cb => {
                ...
                const selIst = cb.closest('label').querySelector('.mod-ragazzo-istruttore');
                if (sel) {
                    sel.style.display = cb.checked ? 'inline-block' : 'none';
                    if (rag) sel.value = rag.gruppo == 1 ? '1' : '0';
                }
                if (selIst && rag) {
                    const isIndividual = rag.gruppo == 0;
                    selIst.style.display = isIndividual ? 'inline-block' : 'none';
                    if (isIndividual && rag.istruttore_id) {
                        selIst.value = rag.istruttore_id;
                    }
                }
            });
        ...
        document.querySelectorAll('.mod-ragazzo-checkbox').forEach(cb => {
            cb.addEventListener('change', function() {
                const label = this.closest('label');
                const sel = label.querySelector('.mod-ragazzo-gruppo');
                const selIst = label.querySelector('.mod-ragazzo-istruttore');
                if (sel) sel.style.display = this.checked ? 'inline-block' : 'none';
                if (selIst) {
                    if (this.checked && sel && parseInt(sel.value) === 0) {
                        selIst.style.display = 'inline-block';
                    } else {
        ...
        document.querySelectorAll('.mod-ragazzo-gruppo').forEach(select => {
            select.addEventListener('change', function() {
                const label = this.closest('label');
                const selIst = label.querySelector('.mod-ragazzo-istruttore');
                if (selIst) {
                    selIst.style.display = parseInt(this.value) === 0 ? 'inline-block' : 'none';
                }
            });
        });
                ...
                fetch('api/api_modifica_agenda.php', {
                        ...
                        headers: {
                         ...
                         body: JSON.stringify({
                            ...
                            ragazzi,
                            ragazzi_gruppo,
                            note: document.getElementById('modAgendaNote').value.trim()
                        })
                    })
                    .then(r => r.json()).then(data => {
                        if (data.success) {
        ...
        // ── Gestione selettore istruttore per ragazzi in modalità individuale ──
        function updateIstruttoriSelects() {
            const educatori = Array.from(document.querySelectorAll(".educatore-checkbox:checked"))
                .map(cb => ({
                    id: parseInt(cb.value, 10),
                    label: cb.closest('label').querySelector('span').textContent.trim()
                }))
            ...
            document.querySelectorAll('.ragazzo-istruttore').forEach(select => {
                const lbl = select.closest('label');
                const cb = lbl.querySelector('.ragazzo-checkbox');
                const selGruppo = lbl.querySelector('.ragazzo-gruppo');
                const isChecked = cb && cb.checked;
                const isIndividuale = selGruppo && parseInt(selGruppo.value) === 0;
        ...
        document.querySelectorAll(".educatore-checkbox").forEach(cb => {
            cb.addEventListener("change", () => {
                updateIstruttoriSelects();
            });
        });
        ...
        document.querySelectorAll('.ragazzo-checkbox').forEach(cb => {
            cb.addEventListener('change', function() {
                ...
                if (this.checked) {
                    ...
                    if (selGruppo) selGruppo.style.display = 'none';
                    if (selIstruttore) selIstruttore.style.display = 'none';
                }
            });
        });

        document.querySelectorAll('.ragazzo-gruppo').forEach(select => {
            select.addEventListener('change', function() {
                const label = this.closest('label');
                const selIstruttore = label.querySelector('.ragazzo-istruttore');
                if (selIstruttore) {
                    if (parseInt(this.value) === 0) {
                        updateIstruttoriSelects();
                        selIstruttore.style.display = 'inline-block';
                    } else {
                        selIstruttore.style.display = 'none';
                        selIstruttore.value = '';
                    }
            ...
            formCreaAgenda.onsubmit = function(e) {
                ...
                fetch("api/api_aggiungi_agenda.php", {
                        ...
                        body: JSON.stringify({
                            ...
                            ragazzi,
                            ragazzi_gruppo,
                            note: document.getElementById('agendaNote').value.trim()
                        })
                    })
                    .then(r => r.json()).then(data => {
                        if (data.success) {
    ...
    <script>
        ...
        (function() {
            ...
            makeBirthdayCal({
                openBtnId: 'birthCalBtnEduAdd',
                overlayId: 'birthCalOverlayEduAdd',
                pickerId: 'birthCalPickerEduAdd',
                gridId: 'birthCalGridEduAdd',
                monthLblId: 'birthCalMonthLabelEduAdd',
                prevMonthId: 'birthCalPrevMonthEduAdd',
                nextMonthId: 'birthCalNextMonthEduAdd',
                prevYearId: 'birthCalPrevYearEduAdd',
                nextYearId: 'birthCalNextYearEduAdd',
                prevDecadeId: 'birthCalPrevDecadeEduAdd',
                nextDecadeId: 'birthCalNextDecadeEduAdd',
                yearSelectId: 'birthCalYearSelectEduAdd',
                displayInputId: 'educatoreDataDisplay',
                hiddenInputId: 'educatoreData',
            });

            makeBirthdayCal({
                openBtnId: 'birthCalBtnEduEdit',
                overlayId: 'birthCalOverlayEduEdit',
                pickerId: 'birthCalPickerEduEdit',
                gridId: 'birthCalGridEduEdit',
                monthLblId: 'birthCalMonthLabelEduEdit',
                prevMonthId: 'birthCalPrevMonthEduEdit',
                nextMonthId: 'birthCalNextMonthEduEdit',
                prevYearId: 'birthCalPrevYearEduEdit',
                nextYearId: 'birthCalNextYearEduEdit',
                prevDecadeId: 'birthCalPrevDecadeEduEdit',
                nextDecadeId: 'birthCalNextDecadeEduEdit',
                yearSelectId: 'birthCalYearSelectEduEdit',
                displayInputId: 'editEducatoreDataDisplay',
                hiddenInputId: 'editEducatoreData',
            });
        })();
